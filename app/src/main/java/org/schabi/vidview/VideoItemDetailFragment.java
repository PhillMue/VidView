...
import org.schabi.vidview.download.DownloadDialog;
import org.schabi.vidview.extractor.AudioStream;
import org.schabi.vidview.extractor.MediaFormat;
import org.schabi.vidview.extractor.ParsingException;
import org.schabi.vidview.extractor.ServiceList;
import org.schabi.vidview.extractor.StreamExtractor;
import org.schabi.vidview.extractor.StreamInfo;
import org.schabi.vidview.extractor.StreamPreviewInfo;
import org.schabi.vidview.extractor.StreamingService;
import org.schabi.vidview.extractor.VideoStream;
import org.schabi.vidview.extractor.services.youtube.YoutubeStreamExtractor;
import org.schabi.vidview.player.BackgroundPlayer;
import org.schabi.vidview.player.PlayVideoActivity;
import org.schabi.vidview.player.ExoPlayerActivity;
...
public class VideoItemDetailFragment extends Fragment {
    ...
    private void updateInfo(final StreamInfo info) {
        try {
            ...
            // Since vidview is designed to work even if certain information is not available,
